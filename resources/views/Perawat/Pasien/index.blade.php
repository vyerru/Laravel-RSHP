...
<div class="container py-4">
    <div class="row mb-4 align-items-center">
        <div class="col-md-6">
            <h2 class="fw-bold text-success mb-0"><i class="bi bi-heart-pulse me-2"></i>Data Pasien</h2>
            <p class="text-muted mb-0">Database pasien dan riwayat medis.</p>
        </div>
        <div class="col-md-6 text-end">
            {{-- Form Pencarian mengarah ke route Perawat --}}
            <form action="{{ route('Perawat.Pasien.index') }}" method="GET" class="d-flex justify-content-md-end">
                        ...
                        <tr>
                            <td class="ps-4">
                                <div class="d-flex align-items-center">
                                    <div class="bg-light rounded-circle p-2 text-success me-3">
                            ...
                            {{-- <td class="text-end pe-4">
                                <a href="{{ route('Perawat.Pasien.show', $pet->idpet) }}" class="btn btn-sm btn-outline-success rounded-pill px-3">
                                    <i class="bi bi-file-medical me-1"></i> Detail
                                </a>
                            </td>- --}}
                        </tr>
                        @empty
